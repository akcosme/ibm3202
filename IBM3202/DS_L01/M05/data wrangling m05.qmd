...
> **note** this code book will follow the structure and content for the project: [M05-1-Data wrangling with Tidyvverse in R](https://jmjung.quarto.pub/m05-1-principles-data-wrangling-with-tidyverse-in-r/)
...
# this is whre we will start to learn about data wrangling with dplyr